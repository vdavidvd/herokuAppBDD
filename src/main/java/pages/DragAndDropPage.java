...
public class DragAndDropPage {
    ...
    private WebElement headerBoxA;

    @FindBy(xpath = "//div[@id='column-b']/header")
    private WebElement headerBoxB;

    public String getHeaderBoxA(){
        return headerBoxA.getText();
    }

    public String getHeaderBoxB(){
        return headerBoxB.getText();
    }
